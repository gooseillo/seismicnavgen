...
router.get('/logout', (req, res) => {
  req.logout();
  res.redirect('http://radixgeo.au.auth0.com/v2/logout?returnTo=http%3A%2F%2Fseismicnavgen-env.fpqwk5uhuy.ap-southeast-2.elasticbeanstalk.com&client_id=pfN6WhslzOJgll5H0V1T6o7bjHOHluQ0');
